...
import (
	...
	examplePetstoreClient "github.com/lkarlslund/oapi-codegen/examples/petstore-expanded"
	examplePetstore "github.com/lkarlslund/oapi-codegen/examples/petstore-expanded/echo/api"
	"github.com/lkarlslund/oapi-codegen/pkg/util"
...
const (
	...
	remoteRefImport = `github.com/lkarlslund/oapi-codegen/examples/petstore-expanded`
)
...
func TestRemoteExternalReference(t *testing.T) {
	...
	// Check import
	assert.Contains(t, code, `externalRef0 "github.com/lkarlslund/oapi-codegen/examples/petstore-expanded"`)
